...
$java -jar  -Xmx4G Jar/NanoporeBC_UMI_finder-2.1.jar assignumis --inFileNanopore ${mappingdir}passed.bam -o ${umidir}passedParsed.bam --annotationFile Gencode/gencode.v18.mm10.refFlat

# Step 4 - option a
$java -jar -Xmx4g Jar/Sicelore-2.1.jar IsoformMatrix I=${umidir}passedParsed.bam REFFLAT=Gencode/gencode.v18.mm10.refFlat CSV=${readscandir}BarcodesAssigned.tsv OUTDIR=$siceloredir PREFIX=reads VALIDATION_STRINGENCY=SILENT
