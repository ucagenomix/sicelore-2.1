...
$java -jar -Xmx4g Jar/NanoporeBC_UMI_finder-2.1.jar tagbamwithread --inFastq ${analysisdir}fastq_pass.fastq.gz --inBam ${umidir}passedParsed.bam --outBam ${siceloredir}passedParsedWithSequences.bam --readTag US --qvTag QS
...
$java -jar -Xmx4g Jar/Sicelore-2.1.jar AddGeneNameTag I ${siceloredir}molecules.bam O ${siceloredir}molecules.GE.bam REFFLAT Data/gencode.v38.chr12.refFlat GENETAG GE ALLOW_MULTI_GENE_READS true USE_STRAND_INFO true VALIDATION_STRINGENCY SILENT
